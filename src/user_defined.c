...
int user_function(grid_t *grid) {
	...
	int a1 = RE_load_asset(
	    "assets/tiles/philticular/isometric_jumpstart_v230311(1)/isometric_jumpstart_v230311/iso_tile_export.png", 256,
	    64, 32, 32);

	int a2 = RE_load_asset(
	    "assets/tiles/philticular/isometric_jumpstart_v230311(1)/isometric_jumpstart_v230311/iso_tile_export.png", 128,
	    192, 32, 32);

	int pl_south = RE_load_asset("assets/characters/scrabling/critters/boar/boar_NW_idle_0.png", 0, 0, 46, 32);

	// int pl_south = RE_load_asset(MAIN_CHAR_IMG_S, MAIN_CHAR_SRC_X, MAIN_CHAR_SRC_Y, MAIN_CHAR_WIDTH,
	// MAIN_CHAR_HEIGHT); int pl_east = RE_load_asset(MAIN_CHAR_IMG_E, MAIN_CHAR_SRC_X, MAIN_CHAR_SRC_Y,
	// MAIN_CHAR_WIDTH, MAIN_CHAR_HEIGHT); int pl_north = RE_load_asset(MAIN_CHAR_IMG_N, MAIN_CHAR_SRC_X,
	// MAIN_CHAR_SRC_Y, MAIN_CHAR_WIDTH, MAIN_CHAR_HEIGHT); int pl_west = RE_load_asset(MAIN_CHAR_IMG_W,
	// MAIN_CHAR_SRC_X, MAIN_CHAR_SRC_Y, MAIN_CHAR_WIDTH, MAIN_CHAR_HEIGHT);
